"""
Kairos Quant System v1 – Entry Point
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def hien_thi_menu():
    ...
    subtitle_text = "Analytics System v1"
    ...
    menu.add_row("[5]", "Dashboard Analytics", "PyQt6 · equity · heatmap · scatter")
    ...
    author.add_row(
        Text(
            "P. Vinh - Financial Data Analyst · Quant Developer",
            style="bold cyan",
        )
    )
    ...
    author.add_row(Rule(style="bright_black"))
    author.add_row(Text("Kairos  v1  ·  2026", style="dim"))
    author.add_row(Text(""))
    ...
    console.print()
    return console.input("[bold yellow]Chon chuc nang [0-5]:[/bold yellow] ").strip()
...
def chay_dashboard():
    """Khởi động dashboard PyQt6 gồm 3 tab: Realtime, Demo, Backtest."""
    ...
    class KairosWindow(QMainWindow):
        def __init__(self):
            """Khởi tạo cửa sổ chính với 3 tab dashboard."""
            super().__init__()
            self.setWindowTitle("Kairos v1 – Analytics Dashboard")
