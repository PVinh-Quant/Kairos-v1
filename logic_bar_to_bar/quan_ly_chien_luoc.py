"""
logic_bar_to_bar/quan_ly_chien_luoc.py – Điều phối chiến lược
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Bộ điều phối chiến lược giao dịch đa khung thời gian.
Luồng xử lý:
  1. Gọi phan_tich_trang_thai_thi_truong() để kiểm tra bộ lọc thời gian/dữ liệu
  2. Kiểm tra song song 5 chiến lược (Breakout, Mean Reversion, Scalping, Squeeze, Trend Following)
...
def chien_luoc_vao_lenh(
    ...
    """Entry point cho mỗi lần quét. Trả về (tin_hieu, diem, chien_luoc, ly_do, None)."""

    cho_phep, _ = phan_tich_trang_thai_thi_truong(
    ...
    if tin_hieu and abs(diem) >= 20:
        return tin_hieu, diem, "Breakout", ly_do, None
    ...
    if tin_hieu and abs(diem) >= 20:
        return tin_hieu, diem, "Mean_reversion", ly_do, None
    ...
    if tin_hieu and abs(diem) >= 20:
        return tin_hieu, diem, "Scalping", ly_do, None
    ...
    if tin_hieu and abs(diem) >= 20:
        return tin_hieu, diem, "Squeeze", ly_do, None
    ...
    if tin_hieu and abs(diem) >= 20:
        return tin_hieu, diem, "Trend_following", ly_do, None
